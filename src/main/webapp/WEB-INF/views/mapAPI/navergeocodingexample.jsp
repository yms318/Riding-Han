		...
		<div class="container">
			<div class="navbar-header">
				<a class="navbar-brand" href="index.html"> <img
					class="branding-logo" src="./img/logo.png" alt="logo">

				</a> <a class="navbar-brand-naver-developers"
					href="https://developers.naver.com/main"> <img
					src="./img/logo_naverDevelopers.png" width="180px" height="21px">
				</a>
			...
			<div class="col-md-12">
				<div id="main" itemscope itemtype="https://schema.org/TechArticle">
					...
					<script type="text/javascript"
						src="https://openapi.map.naver.com/openapi/v3/maps.js?ncpClientId=83bfuniegk&amp;submodules=panorama,geocoder,drawing,visualization"></script>
					<link rel="stylesheet" type="text/css" href="./css/base.css" />

					<section class="tutorial-section">
						<header></header>
						<article>
							<h1>주소와 좌표 검색 API 사용하기</h1>
							<style type="text/css">
								.search {
									position: absolute;
									z-index: 1000;
