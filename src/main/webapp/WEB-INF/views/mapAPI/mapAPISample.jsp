...
<script id="code">
	...
	function makeDirectionMatrix(resDirections) {
		// directions 비우기
		while (directions.length > 0) {
			directions.shift();
		}
		$.each(resDirections, function(i, direc) {
			var direcPoint = new naver.maps.LatLng(direc[1], direc[0]);
			directions.push(direcPoint);
		})
	}
