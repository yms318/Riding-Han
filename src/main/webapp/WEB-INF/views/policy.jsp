		...
		<div id="container">
			...
			<div class="s-content opacity" data-animation-effect="fadeInUp" data-effect-delay="100">
				<div class="inner down-bx">
					...
					<p class="poltxt">㈜달려라한강은 (이하 '회사'는) 통신비밀보호법, 전기통신사업법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률, 개인정보보호법 및 동법 시행령 등 정보통신서비스 제공자가 준수하여야 할 관련 법령상의 개인정보보호 규정을 준수하며, 관련 법령에 의거한 개인정보처리방침을 정하여 고객님의 권익 보호에 최선을 다하고 있습니다.</p>
					<p class="poltxt">개인정보 처리방침(이하 “본 처리방침”이라 함)”이란 이용자의 소중한 개인정보를 보호하여 이용자가 안심하고 서비스를 이용할 수 있도록 회사가 준수해야 할 지침을 말하고, 회사는 본 처리방침을 통하여 이용자가 제공하는 개인정보를 어떠한 용도와 방식으로 이용하고 있으며, 회사가 개인정보보호를 위해 어떠한 조치를 취하고 있는지 알려드리고자 합니다. 본 처리방침은 회사가 운영하는 사이트에서 제공하는
						인터넷 관련 서비스에 적용됩니다.</p>
					<p class="poltxt">㈜달려라한강의 개인정보처리방침은 다음과 같은 내용을 담고 있습니다.</p>
					...
					<p class="poltxt">㈜달려라한강은 이용자의 동의 없이 이용자의 개인정보 취급을 외부 업체에 위탁하지 않습니다. 향후 그러한 필요가 생길 경우, 위탁 대상자와 위탁 업무 내용을 이용자에게 통지하고 필요한 경우 사전 동의를 받도록 하겠습니다.</p>
					...
					<ul class="ul-list02">
						...
						<li>개인정보의 훼손에 대비해서 자료를 수시로 백업하고 있고, 최신 백신프로그램을 이용하여 이용자들의 개인정보나 자료가 누출되거나 손상되지 않도록 방지하고 있으며, 암호화통신 등을 통하여 네트워크상에서 개인정보를 안전하게 전송할 수 있도록 하고 있습니다. 그리고 침입차단시스템을 이용하여 회부로부터의 무단 접근을 통제하고 있으며, 기타 시스템적으로 보안성을 확보하기 위한 가능한 모든 기술적 장치를 갖추려 노력하고 있습니다.
						</li>
					</ul>
					<h5 class="sub-tit1">3) 개인정보담당자의 운영 및 교육</h5>
					<ul class="ul-list02">
						<li>개인정보담당자의 인원을 최소화하고 있으며, 개인정보관련 수시 교육을 통해 개인정보처리방침의 준수를 강조하고 있으며, 개인정보취급방침의 이행사항 및 담당자의 준수여부를 확인하여 문제가 발견될 경우 즉시 수정하고 바로잡을 수 있도록 노력하고 있습니다. 다만, 회사가 개인정보보호 의무를 다 하였음에도 불구하고 이용자 본인의 부주의나 회사가 관리하지 않는 영역에서의 사고 등 회사의 귀책에 기인하지 않은 손해에 대해서는
							회사는 일체의 책임을 지지 않습니다.</li>
					</ul>
					...
					<ul class="ul-list02">
						<li><span>개인정보 관리담당자 </span>
							<ul>
								<li>성명: 성정민</li>
								<li>소속: 경영지원팀</li>
								<li>이메일: <a href="hellojeongmin@gmail.com">hellojeongmin@gmail.com</a></li>
							</ul>
						</li>
					...
					<ul class="ul-list03">
						<li>부칙</li>
						<li>본 개인정보 처리방침은 2020년 2월 25일부터 시행됩니다. </li>
					</ul>
				</div>
			</div><!-- /s-content-->
